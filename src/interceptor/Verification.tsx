...
import CookieService from "../service/cookie/CookieService.ts";
...
const Verification: React.FC = () => {
    ...
    useEffect(() => {
        const checkToken = async () => {
            ...
            if (isAuthenticated) {
                navigate("/process/frontdesk/dashboard", {replace: true});
            } else {
                ...
                CookieService.set('currentApp', 'FRONT_DESK', cookieDomain, 90);
