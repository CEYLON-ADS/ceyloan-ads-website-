                    ...
                    {hasImages && images.length > 0 ? (
                        <>
                            ...
                            <div className="relative w-full h-full">
                                ...
                                {/* Dot Navigation */}
                                <div
                                    className="absolute bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:space-x-3">
                                    {images.map((_, index) => (
                                        <button
                                            key={index}
                        ...
                        <div className="flex items-center justify-center h-full">
                            <div className="text-center p-4 sm:p-8">
                                ...
                                <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">Premium Banner
                                    Space</h3>
